...
- Promote the frozen feature-complete API to the 1.0 release-candidate line, add
  exact-artifact stable rehearsal and rollback gates, and publish the final
  security, compatibility, migration, and soak-equivalent audit records without
